...
- 案例参考（11 版翻盘）：`handoff/results/case-17-公关经理介绍排成一排.md`
...
不适合 D-1 叙事拼接时的备选方案：
- **方案 A**：放弃叙事框架，改为"心境四联画"——4 段不强调时序，用统一调色+段间慢溶解+不写"段 1/2/3/4"的顺承逻辑
...
" handoff/results/case-XX-xxx.md
```
...
| 场景类型 | Hook 范式 | 文件位置 |
|---------|---------|---------|
| 演唱会前排追星 | 凝视模式 | `handoff/results/case-01-演唱会.md` 第 15 节 v5（1456 字符） |
| 多人场景合影前打闹 | 凝视模式 + 跨人物互动 | `handoff/results/case-03-化妆间.md` 第 15 节 v5（1701 字符） |
| 课堂偷拍 | 凝视模式 + 时间分段 | `handoff/results/case-04-讲课.md` 第 15 节 v5（1886 字符） |
| 直播流偷拍看球 | 凝视模式（奠基 case） | `handoff/results/case-05-球场大屏.md` 第 15 节 v4.1（1408 字符） |
