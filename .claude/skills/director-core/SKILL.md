...
路由到 `director-interview`。

收集制作电影所需的最低可行简报。`director-interview` 根据输入创意清晰度自动选择路径：

| 输入质量 | 路径 |
|---|---|
| 创意完整（主体+动作+场景+情绪） | 快速通道 → 直接确认 |
| 描述充分但缺剧情（有场景/风格/调性，缺叙事动作） | 创意展开 → 2-3 方案供选择 |
| 创意模糊（仅主题词/宽泛概念） | 创意访谈 → 逐项问清 |
