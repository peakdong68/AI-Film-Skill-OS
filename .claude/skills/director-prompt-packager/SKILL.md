...
- After user confirms the prompt package, save to `outputs/F-[N]-[topic]-State-4-prompt-package.md`
- Notify the user: "✅ Saved to `outputs/F-[N]-[topic]-State-4-prompt-package.md`"
