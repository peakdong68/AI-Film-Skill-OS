...
- **能力**: 7 种生成模式（T2V / I2V minimal / I2V storyboard / R2V / FLF2V / V2V Edit / V2V Extend），官方 `@[imageN]` 参考格式，动作描述四规则，特殊字符规范
...
9. **官方格式**: 参考素材使用 `@[imageN]` / `@[videoN]` / `@[audioN]` 格式，对齐 Seedance 2.0 官方语法。
